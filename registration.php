            ...
            <i class="fas fa-bars"></i>
                ...
                <?php
                    ...
                    if (isset($_REQUEST['username'])) {                       
                        ...
                        $query    = "INSERT INTO `users` (username,  firstname, lastname,password,email,create_datetime, dob)
                                    VALUES ('$username','$firstname', '$lastname', '" . md5($password) . "', '$email','$create_datetime','$dob')";
